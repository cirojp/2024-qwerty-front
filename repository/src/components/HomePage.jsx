...
function HomePage() {
    ...
    return (
        ...
        <div className="flex justify-between items-center px-4">
            ...
            {/* Botón "Mi Cuenta" a la derecha con margen */}
            <div className="mt-5 flex flex-col md:flex-row justify-end space-y-4 md:space-y-0 md:space-x-4 mr-4">
                <button 
            ...
            <div className="flex justify-between items-center mb-0 px-6">
                ...
                <h2 className="text-2xl py-2 px-4 font-bold text-left mb-4 text-gray-100">
                Historial de Transacciones
                </h2>

                {/* Botón de agregar transacción centrado debajo del logo */}
                <button 
                ...
                {/* Selector de categorías alineado a la derecha */}
