...
function ModalForm({ isModalOpen, closeModal, agregarTransaccion, edit, motivo, valor, fecha, handleMotivoChange, setValor, selectedCategory, payCategories, handleCategoryChange, handleCreateCat, setFecha}) {
    const customStyles = {
        overlay: {
            position: 'fixed',
            top: 0,
